...
const ECRANS = [
  ...
  { dossier: "espace",      url: "/espace",       titre: "Mon espace" },
  { dossier: "recherche",   url: "/recherche",    titre: "Chercher" },
  { dossier: "artisan",     url: "/artisan",      titre: "Fiche" },
  { dossier: "demandes",    url: "/demandes",     titre: "Mes demandes" },
  { dossier: "messages",    url: "/messages",     titre: "Mes messages" },
  { dossier: "mes-donnees", url: "/mes-donnees",  titre: "Mes donnees" },
